...
export default function App() {
    ...
    return (
      <>
        <div className='m-0 font-[Poppins,sans-serif] bg-gradient-to-r from-gray-800 to-yellow-500 flex justify-center bg-cover bg-no-repeat items-center min-h-screen w-full p-4 md:p-6'>
